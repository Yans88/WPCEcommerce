	...
	<div class="box box-warning">
		<div class="box-header with-border">
            ...
            <div class="pull-right">
				<select name="ocrcode_c" id="ocrcode_c" style="height:27px;" onchange="return get_type(this.value);">
					<option value="">-- Pilih Ocrcode C --</option>					
				</select>
				
				<button class="btn btn-xs btn-warning btn_apply" disabled style="height:27px;"><i class="glyphicon glyphicon-search"></i> Apply</button>
...
function get_type(val){	
	...
	if(val != '') $('.btn_apply').prop('disabled', false);
}
...
$('.btn_apply').click(function(){
	...
	var url = '<?php echo site_url('product/apply_ocrcode_c');?>';
	$.ajax({
		data : {id_diskon:$('#id_diskon').val(),ocrcode_c:ocrcode_c, id_product:id_product},
		url : url,
		type : "POST",
		success:function(response){
			$('.btn_apply').prop('disabled', true);
