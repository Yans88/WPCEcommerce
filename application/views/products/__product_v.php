...
<div class='alert alert-info alert-dismissable' id="success-alert">
	...
	<table id="example88" class="table table-bordered table-striped">
		...
		<tbody>
			...
			<button title="Delete" id="'.$p['id_product'].'" class="btn btn-xs btn-danger del_news" style="margin-top:2px;"><i class="fa fa-trash-o"></i> Delete</button>	
			<a href="'.site_url('product/view_stock/'.$this->converter->encode($p['id_product'])).'" title="View Stock"><button class="btn btn-xs btn-warning" style="margin-top:2px;"><i class="fa fa-eye"></i> View Stock</button></a>
						</td>';
						echo '</tr>';
					}
				}
